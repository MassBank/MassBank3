...
// Accepts only nested slice of MbRecord (e.g. [][]MbRecord), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseMbRecordRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aMbRecord, ok := obj.(MbRecord)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertMbRecordRequired(aMbRecord)
	})
}
