...
// AssertMbRecordCommentsInnerConstraints checks if the values respects the defined constraints
func AssertMbRecordCommentsInnerConstraints(obj MbRecordCommentsInner) error {
	return nil
}
